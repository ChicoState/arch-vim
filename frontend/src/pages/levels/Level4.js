...
function Level4Nav({ safeClosePromise }) {
...
export default function Level4() {
  ...
  return (
    ...
    <div class="level4" >
      <Level4Nav safeClosePromise={safeClosePromise} />
      <div class="level_info" style={{ padding: "10px" }}>
        <h1>Level 3</h1>
        <h3>Learn how to save a file </h3>
        <p>
          You are stuck in insert Mode! NOO! how to Escape?
          <br />
          Hit the Esc button
          <br />
          Typing <strong>:w</strong> will save the file
          <br />
          If you want to save and exit the file, type <strong>:wq</strong>
          <br />
          <br />
          Objective: Add text and Save the file.
        </p>
      </div>
      <div class="editor">
        { showEditor ? (
